          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="w-full max-w-[95vw] transform overflow-hidden rounded-2xl bg-[#1a1a1a] p-0 text-left align-middle shadow-2xl transition-all border border-neutral-800">
                ...
                {/* Content Area */}
                <div className="flex flex-col lg:flex-row bg-black gap-0 overflow-y-auto lg:overflow-hidden h-auto lg:h-[80vh]">
                  {/* Video Area */}
                  <div className="relative w-full shrink-0 aspect-video lg:aspect-auto lg:flex-[4] bg-black min-h-[200px]">
                    <iframe
                      src={embedUrl}
                  ...
                  {/* Chat Area - Sidebar */}
                  <div className="w-full shrink-0 h-[500px] lg:h-full lg:flex-1 bg-[#111] border-l border-neutral-800 shadow-2xl relative z-10">
                    <iframe
                      src={chatUrl}
